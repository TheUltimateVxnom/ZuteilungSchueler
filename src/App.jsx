...
export default function App() {
  ...
  const assign = () => {
    ...
    // History nur für aktuell zugewiesene Schüler
    const newHistory = {};
  ...
  const exportJSON = () => {
    const blob = new Blob(
      [JSON.stringify({ students, capacityOutside, capacityGroup, history }, null, 2)],
  ...
  return (
    <div className="app-container">
      <div className="app-inner" style={{ maxWidth: "1000px", margin: "0 auto" }}>
        ...
        <main className="app-main">
          <section className="card">
            ...
            <div className="card-buttons">
              <button onClick={assign} className="btn btn-primary">
                Zuweisen
              </button>
